...
# Question model: defines an exam question that belongs to a course
...
# Choice model: defines a possible answer option for a Question
...
# Submission model: records the set of choices a learner submitted for an exam attempt
